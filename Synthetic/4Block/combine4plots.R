...
read_result = function(file) {
  read.csv(file.path(res_dir, file))
}
...
A = read_result(
  "summary_varyK_randomXY_N100_T80_r6_SNR1_N170-70_T160-60_nrep500_tau0.01.csv"
)

B = read_result(
  "summary_varyKZoom_randomXY_N100_T80_r6_SNR1_N170-70_T160-60_nrep500_tau0.01.csv"
)

C = read_result(
  "summary_varyK_leadingEigXY_N100_T80_r6_SNR1_N130-70_T130-60_nrep500_tau0.01.csv"
)

D = read_result(
  "summary_varyK_multiSNR_randomXY_N100_T80_r6_SNRtarget1-100-10000_N170-70_T160-60_nrep500_tau0.01.csv"
)
...
D = D %>%
  ...
  mutate(
    SNR_label = factor(
      ...
      labels = c("SNR = 1", "SNR = 0.01", "SNR = 0.0001")
    ),
    logMSE = log10(MSE),
